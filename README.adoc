 ...
 * Portability. Runs on the following platforms:
   ...
   - Alpha: Linux (Debian).
   - AMD64 (x86-64): Darwin (Mac OS X), FreeBSD, Linux (Debian, Fedora, Ubuntu, ...),
     OpenBSD, Solaris (10 and above).
   - ARM: Linux (Debian, Fedora).
   - ARM64 (AArch64): Linux (Debian, Fedora).
   ...
   - PowerPC64: AIX (5.2 and above), Linux (Debian, Fedora).
   - RISC-V: Linux (Fedora).
   - S390: Linux (Debian, Fedora).

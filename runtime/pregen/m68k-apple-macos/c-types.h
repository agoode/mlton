...
typedef /* size_t */ Word32_t C_Size_t;

typedef /* unsigned char* */ Word32_t C_Pointer_t;
typedef /* char* */ Word32_t C_String_t;
typedef /* char** */ Word32_t C_StringArray_t;
...
/* C99 */
typedef /* ptrdiff_t */ Int32_t C_Ptrdiff_t;
typedef /* intmax_t */ Int64_t C_Intmax_t;
typedef /* uintmax_t */ Word64_t C_UIntmax_t;
typedef /* intptr_t */ Int32_t C_Intptr_t;
typedef /* uintptr_t */ Word32_t C_UIntptr_t;

/* from <dirent.h> */
typedef /* DIR* */ Word32_t C_DirP_t;

/* from <poll.h> */
typedef /* nfds_t */ Word32_t C_NFds_t;

/* from <resource.h> */
typedef /* rlim_t */ Word32_t C_RLim_t;

/* from <sys/types.h> */
typedef /* clock_t */ Word32_t C_Clock_t;
typedef /* dev_t */ Int16_t C_Dev_t;
typedef /* gid_t */ Word16_t C_GId_t;
typedef /* ino_t */ Word16_t C_INo_t;
typedef /* mode_t */ Word32_t C_Mode_t;
typedef /* nlink_t */ Word16_t C_NLink_t;
typedef /* off_t */ Int32_t C_Off_t;
typedef /* pid_t */ Int32_t C_PId_t;
typedef /* ssize_t */ Int32_t C_SSize_t;
typedef /* suseconds_t */ Int32_t C_SUSeconds_t;
typedef /* time_t */ Int64_t C_Time_t;
typedef /* uid_t */ Word16_t C_UId_t;
...
/* from "gmp.h" */
typedef /* mp_limb_t */ Word32_t C_MPLimb_t;
